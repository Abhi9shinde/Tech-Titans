        ...
        <div className="h-screen grid md:grid-cols-2 gap-12 items-center">
          <div className="animate__animated animate__fadeInLeft">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="/signin" className="bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-full font-medium text-center transition-all transform hover:scale-105 inline-flex items-center space-x-2">
                Join The Challenge <span><img src="/images/ecoFriendly.avif" alt="" className="rounded-full h-8 ml-2" /></span>
              </a>
              <a href="/phases" className="border border-white hover:bg-white hover:text-neutral-900 px-8 py-4 rounded-full font-medium text-center transition-all items-center">
                Learn More
              </a>
            </div>
          </div>
