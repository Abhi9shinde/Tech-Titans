...
document.addEventListener('DOMContentLoaded', () => {
  ...
  return (
    <div>
      <section id="community-dashboard" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 animate__animated animate__fadeIn">
                <h2 class="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">Community Dashboard</h2>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Track our collective impact and progress towards a sustainable future.</p>
            </div>
