            ...
            <section id="impact_metrics" class="p-6">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2">
                        <div class="bg-neutral-800 rounded-lg border border-neutral-200/30 p-6">
                            <h2 class="text-xl font-semibold text-white mb-6">Global Impact Metrics</h2>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-emerald-600">12,547</div>
                                    <div class="text-sm text-neutral-400 mt-2">Cups Saved</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-blue-600">627kg</div>
                                    <div class="text-sm text-neutral-400 mt-2">CO2 Reduced</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-purple-600">8,432L</div>
                                    <div class="text-sm text-neutral-400 mt-2">Water Saved</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-yellow-600">₹62,735</div>
                                    <div class="text-sm text-neutral-400 mt-2">Money Saved</div>
                                </div>
                            </div>
                        </div>

                        <div class="bg-neutral-800 rounded-lg border border-neutral-200/30 p-6 mt-6">
                            <div class="flex justify-between items-center mb-6">
                                <h3 class="text-lg font-semibold text-white">Monthly Progress</h3>
                    ...
                    <div class="space-y-6">
                        <div class="bg-neutral-800 rounded-lg border border-neutral-200/30 p-6">
                            <h3 class="text-lg font-semibold text-white mb-4">Health Impact</h3>
                            <div class="space-y-4">
                                <div>
                                    <div class="flex justify-between mb-2">
                                        <span class="text-sm text-neutral-400">BPA Exposure Reduced</span>
                                ...
                                <div>
                                    <div class="flex justify-between mb-2">
                                        <span class="text-sm text-neutral-400">Chemical Leaching Prevention</span>
                        ...
                        <div class="bg-neutral-800 rounded-lg border border-neutral-200/30 p-6">
                            <h3 class="text-lg font-semibold text-white mb-4">Environmental Savings</h3>
                            <div class="space-y-4">
                        ...
                        <div class="bg-neutral-800 rounded-lg border border-neutral-200/30 p-6">
                            <h3 class="text-lg font-semibold text-white mb-4">Campus Goals Progress</h3>
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-neutral-400">Monthly Target</span>
