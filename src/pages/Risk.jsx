            ...
            <section id="environmental-risks" class="py-20 bg-neutral-900 text-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16 animate__animated animate__fadeIn">
                        <h2 class="text-3xl md:text-4xl font-bold mb-4 mt-12">Environmental Risks</h2>
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 ">
                        <a href="https://oceanservice.noaa.gov/facts/microplastics.html" target="_blank" class="bg-neutral-800 rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300 animate__animated animate__fadeInUp">
                            ...
                            <p class="text-gray-400">Paper cups contribute significantly to microplastic pollution due to their plastic lining, typically made of polyethylene, which does not decompose naturally. Over time, this lining breaks down into tiny microplastic particles that infiltrate soil and water systems, posing severe risks to ecosystems. These microplastics can leach harmful chemicals, contaminating groundwater and affecting plant growth.</p>
                            <div class="flex justify-end mt-4">
                                <svg class="w-6 h-6 text-red-500 hover:text-red-700 transition-all duration-300 mt-18" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                </svg>
                            </div>
                        </a>

                        <a href="https://pachamama.org/effects-of-deforestation" target="_blank" class="bg-neutral-800 rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300 animate__animated animate__fadeInUp" style={{ "animation-delay": "0.2s" }}>
                        ...
                        <a href="https://www.repsol.com/en/energy-and-the-future/future-of-the-world/energy-consumption/index.cshtml#:~:text=Energy%20consumption%20is%20the%20total,diesel%2C%20oil%2C%20and%20biomass." target="_blank" class="bg-neutral-800 rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300 animate__animated animate__fadeInUp" style={{ "animation-delay": "0.6s" }}>
                            ...
                            <div class="flex justify-end mt-4">
                                <svg class="w-6 h-6 text-green-500 hover:text-green-700 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                </svg>
                            </div>
                        </a>
                        ...
                        <a href="https://www.nrdc.org/stories/water-pollution-everything-you-need-know" target="_blank" class="bg-neutral-800 rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300 animate__animated animate__fadeInUp" style={{ "animation-delay": "0.8s" }}>
                            ...
                            <p class="text-gray-400">The manufacturing of paper cups involves chemical treatments and coating processes that often result in harmful runoff, contaminating nearby water sources. During production, chemicals such as bleach, dyes, and coatings are used to process the paper pulp and create the plastic lining, all of which can seep into the water system if not properly managed. When these chemicals reach rivers, lakes, or oceans, they disrupt aquatic ecosystems, harming fish and other marine life.</p>
                            <div class="flex justify-end mt-4">
                                <svg class="w-6 h-6 text-purple-500 hover:text-purple-700 transition-all duration-300 mt-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                </svg>
                            </div>
                        </a>
                        ...
                        <a href="https://www.activesustainability.com/environment/landfills-serious-problem-environment/" target="_blank" class="bg-neutral-800 rounded-xl p-6 hover:transform hover:scale-105 transition-all duration-300 animate__animated animate__fadeInUp" style={{ "animation-delay": "1s" }}>
