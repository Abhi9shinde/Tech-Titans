            ...
            content: (
                <div>
                    <p
                        ...
                        <span className="text-[#262626]">Raw Material Extraction</span>
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-semibold mb-2">
                        1. Tree Cutting:
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-xl font-normal mb-8 pl-20">
        ...
        // PHASE 2
        {
            ...
            content: (
                <div>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-4xl font-bold mb-8">
                        <span className="text-[#262626]"> Manufacturing Process</span>
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-semibold mb-2">
        ...
        // PHASE 3
        {
            ...
            content: (
                <div>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-4xl font-bold mb-8">
                        <span className="text-[#262626]">Transportation</span>
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-semibold mb-2">
                        1. Carbon Footprint:
        ...
        // PHASE 4?
        {
            ...
            content: (
                <div>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-4xl font-bold mb-8">
                        <span className="text-[#262626]">Usage Phase</span>
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-semibold mb-2">
                        1. Single-Use Nature:
        ...
        // PHASE 5
        {
            ...
            content: (
                <div>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-4xl font-bold mb-8">
                        <span className="text-[#262626]">Disposal Phase</span>
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-semibold mb-2">
                        1. Landfills:
        ...
        // PHASE 6
        {
            ...
            content: (
                <div>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-4xl font-bold mb-8">
                        <span className="text-[#262626]">Long-Term Environmental Impact</span>
                    </p>
                    <p
                        className="text-neutral-800 dark:text-neutral-200 text-xs md:text-2xl font-semibold mb-2">
